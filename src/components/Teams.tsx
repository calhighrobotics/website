      ...
      <Navbar></Navbar>
        <div class="bg-black h-screen flex flex-col w-full break-normal"> 
          ...
          <div class="flex flex-row w-full pt-5"> 
            <Team name="Team 1516A" image={teama} members={["Alejandro", "Sachit", "Sushrut", "Yashica", "Kadon", "Vaishnavi", "Kanishk"]} achievements={["Made it to states in VRC Tipping Point 21-22", "Made it to states in VRC Spin Up 21-22"]}></Team>
